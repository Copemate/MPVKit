...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
          name: "Libmpv",
          url: "https://github.com/Copemate/MPVKit/releases/download/0.40.2/Libmpv.xcframework.zip",
          checksum: "2fc666a2dc1d04ee4be6fe09341e6f76f12522f3d4e09a88b8c3f7d505e3c325"
          ),
